...
def index(request):
    ...
    return render(request, 'stocks/index.html', context={"FRENCH_TICKERS": FRENCH_TICKERS, "stocks": stocks["Stocks"], "images": images})
...
def visualize_data(request):
    ...
    for i in FRENCH_TICKERS:
        stock = Stock(name=i, symbol=i)
        stock.initialize_fundamentals_data()
        stock.get_floating_stock()
        print(stock.name)
        print(stock.floating_stock)
